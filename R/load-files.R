...
#' using `read_csv` and loads them into the
...
#' @param rename A function that is used to rename files (after removing the extension) before they are passed to `make.names`.
